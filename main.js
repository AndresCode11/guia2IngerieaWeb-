$(document).ready(function(){
    ...
    document.getElementById('add-btn').addEventListener('click', function(){
        ...
        if(code == '' || name == '' || second_name == '' || note == '' || age == '' ) {
    ...
    function loadTable(data){
        document.getElementById('table-container').innerHTML = '<table id="student_table"></table>'
        $('#student_table').DataTable({
            ...
            columns: [
                ...
                { title: "Extn.", data: 'note' },
                { title: "Notas", data: 'age' },
            ]
        });
    }
})
